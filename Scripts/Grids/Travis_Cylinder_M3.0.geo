...
radius   =  0.50;
bndSize  =  0.15;
shkSize1 = -0.10;   //  X position of M shock connector (larger + moves to left)
shkSize3 =  1.25;   //  Y position of M shock connector
shkSize2 =  0.40;   //  X position of W shock connector
...
pV1  = newp; Point(pV1)  = {4.0,yCenter+sqrt2Inv*radPbndS+0.00,0.0,charLength};                      //p33
pV2  = newp; Point(pV2)  = {4.0,yCenter-sqrt2Inv*radPbndS-0.00,0.0,charLength};                      //p34
pV3  = newp; Point(pV3)  = {4.0,+yMax,0.0,charLength};                                              //p35
pV4  = newp; Point(pV4)  = {4.0,-yMax,0.0,charLength};                                              //p36
pV5  = newp; Point(pV5)  = {4.0,yCenter+sqrt2Inv*radPbndS+0.55,0.0,charLength};                     //p37
pV6  = newp; Point(pV6)  = {4.0,yCenter-sqrt2Inv*radPbndS-0.55,0.0,charLength};                     //p38
...
Transfinite Line{-lBndS5,-lBndS6}                   = 6  Using Progression 0.9;
...
nVertTBFar = 10 ;
nVertMFar  = 17 ;
Transfinite Line{LBottom3,LHorizFar1,LHorizFar2,LHorizFar3,LHorizFar4,LTop3}   = nFarX       Using Progression 1.014  ;
Transfinite Line{LmidVert1,-LmidVert5}                    = nVertTBFar  Using Progression 0.85 ;
Transfinite Line{LFarVert1,-LFarVert5}                    = nVertTBFar  Using Progression 0.9 ;
...
Transfinite Line{+LBottom2,+LTop2}                                         = nHorizonMid Using Progression 1.0 ;
