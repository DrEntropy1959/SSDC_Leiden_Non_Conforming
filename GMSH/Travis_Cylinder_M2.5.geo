...
radius   =  0.50;
bndSize  =  0.15;
shkSize1 = +0.25;   //  X position of M shock connector
shkSize3 =  1.25;   //  Y position of M shock connector
shkSize2 =  0.70;   //  X position of W shock connector
...
pV1  = newp; Point(pV1)  = {2.75,yCenter+sqrt2Inv*radPbndS+0.00,0.0,charLength};                      //p33
pV2  = newp; Point(pV2)  = {2.75,yCenter-sqrt2Inv*radPbndS-0.00,0.0,charLength};                      //p34
pV3  = newp; Point(pV3)  = {2.75,+yMax,0.0,charLength};                                              //p35
pV4  = newp; Point(pV4)  = {2.75,-yMax,0.0,charLength};                                              //p36
pV5  = newp; Point(pV5)  = {2.75,yCenter+sqrt2Inv*radPbndS+0.55,0.0,charLength};                     //p37
pV6  = newp; Point(pV6)  = {2.75,yCenter-sqrt2Inv*radPbndS-0.55,0.0,charLength};                     //p38
