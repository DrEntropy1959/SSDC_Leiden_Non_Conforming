...
radius   =  0.50;
bndSize  =  0.15;
shkSize1 = -0.05;   //  X position of M shock connector
shkSize3 =  1.15;   //  Y position of M shock connector
shkSize2 =  0.25;   //  X position of W shock connector
shkSize4 =  1.30;   //  Y position of W shock connector
shkSize5 =  0.35;
shkSize6 =  0.50;
...
pV1  = newp; Point(pV1)  = {4.75,yCenter+sqrt2Inv*radPbndS+0.1,0.0,charLength};                      //p33
pV2  = newp; Point(pV2)  = {4.75,yCenter-sqrt2Inv*radPbndS-0.1,0.0,charLength};                      //p34
pV3  = newp; Point(pV3)  = {4.75,+yMax,0.0,charLength};                                              //p35
pV4  = newp; Point(pV4)  = {4.75,-yMax,0.0,charLength};                                              //p36
pV5  = newp; Point(pV5)  = {4.75,yCenter+sqrt2Inv*radPbndS+0.75,0.0,charLength};                     //p37
pV6  = newp; Point(pV6)  = {4.75,yCenter-sqrt2Inv*radPbndS-0.75,0.0,charLength};                     //p38

// Vertical line at Xmax
pV7  = newp; Point(pV7)  = {xMax,yCenter+sqrt2Inv*radPbndS,0.0,charLength};                          //p39
pV8  = newp; Point(pV8)  = {xMax,yCenter-sqrt2Inv*radPbndS,0.0,charLength};                          //p40
pV9  = newp; Point(pV9)  = {xMax,yCenter+sqrt2Inv*radPbndS+0.8,0.0,charLength};                      //p41
pV10 = newp; Point(pV10) = {xMax,yCenter-sqrt2Inv*radPbndS-0.8,0.0,charLength};                      //p42
...
Transfinite Line{lShkM1,lShkW1,-lShkM3,-lShkW3}   = 8  Using Progression 0.99;
...
nVertTBFar = 10 ;
nVertMFar  = 20 ;
Transfinite Line{LBottom3,LHorizFar1,LHorizFar2,LHorizFar3,LHorizFar4,LTop3}   = nFarX       Using Progression 1.02  ;
Transfinite Line{LFarVert1,LmidVert1,-LFarVert5,-LmidVert5}                    = nVertTBFar  Using Progression 0.9 ;
Transfinite Line{LFarVert3,LmidVert3}                                          = nVertTBFar  Using Bump 1.0 ;
...
Transfinite Line{-LBottom1,-LTop1}                                         = nHorizonIn  Using Progression 1.2 ;
