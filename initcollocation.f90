...
!=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
  ...
  subroutine ExtrpXA2XB_2D(NPtsA,NPtsB,XA,XB,fA,fB,Extrp_x1,Extrp_x2)
...
!=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
  ...
  subroutine ExtrpXA2XB_2D_neq(neq,NPtsA,NPtsB,XA,XB,fA,fB,Extrp_x1,Extrp_x2)
