...
contains
  ...
  subroutine init_edge_2()    !   SERIAL Routine
    ...
    ! Required info about the edge_2 elements to fully define the connectivity. 
    ! This is in compliance with the CGNS standard
  ...
  subroutine init_quad_4()     !  SERIAL Routine
    ...
    ! Required info about the quad_4 elements to fully define the connectivity. 
    ! This is in compliance with the CGNS standard
...
!               1-----------------2             ----------> xi
    ...
    ! Require info about the hex_8 elements to fully define the connectivity. 
    ! This is in compliance with the CGNS standard
